...
#endif
#ifdef USE_nerdaxe
bool opt_nerdaxe_noboost = 0;
bool opt_nerdaxe_lowboost = 0;
bool opt_nerdaxe_detect = 0;
float opt_nerdaxe_tune_down = 95;
float opt_nerdaxe_tune_up = 97;
float opt_nerdaxe_wait_factor = 0.5;
float opt_nerdaxe_step_freq = 6.25;
int opt_nerdaxe_bauddiv = 0;
int opt_nerdaxe_freq = 200;
int opt_nerdaxe_start_freq = 100;
int opt_nerdaxe_step_delay = 15;
int opt_nerdaxe_tune2 = 0;
#endif
#ifdef USE_GEKKO
...
#endif
#ifdef USE_nerdaxe
	OPT_WITHOUT_ARG("--nerdaxe-usb-detect",
			 opt_set_bool, &opt_nerdaxe_detect,
			 "Detect nerdaxe Miner USB Device"),
	OPT_WITHOUT_ARG("--nerdaxe-noboost",
			 opt_set_bool, &opt_nerdaxe_noboost,
			 "Disable nerdaxe AsicBoost"),
	OPT_WITHOUT_ARG("--nerdaxe-lowboost",
			 opt_set_bool, &opt_nerdaxe_lowboost,
			 "nerdaxe AsicBoost - 2 midstate"),
	OPT_WITH_ARG("--nerdaxe-tune-down",
		     set_float_0_to_500, opt_show_floatval, &opt_nerdaxe_tune_down,
		     "Set nerdaxe miner minimum hash quality, range 0-100"),
	OPT_WITH_ARG("--nerdaxe-tune-up",
		     set_float_0_to_500, opt_show_floatval, &opt_nerdaxe_tune_up,
		     "Set nerdaxe miner ramping hash threshold, rante 0-99"),
	OPT_WITH_ARG("--nerdaxe-wait-factor",
		     set_float_0_to_500, opt_show_floatval, &opt_nerdaxe_wait_factor,
		     "Set nerdaxe miner task send wait factor, range 0.01-2.00"),
	OPT_WITH_ARG("--nerdaxe-bauddiv",
		     set_int_0_to_9999, opt_show_intval, &opt_nerdaxe_bauddiv,
		     "Set nerdaxe baud divider {0: auto, 1: 1.5M, 7: 375K, 13: 214K, 25: 115K}"),
	OPT_WITH_ARG("--nerdaxe-freq",
		     set_int_0_to_9999, opt_show_intval, &opt_nerdaxe_freq,
		     "Set nerdaxe ASIC frequency in MHz, range 100-800"),
	OPT_WITH_ARG("--nerdaxe-start-freq",
		     set_int_0_to_9999, opt_show_intval, &opt_nerdaxe_start_freq,
                     "Ramp start frequency MHz 25-500"),
	OPT_WITH_ARG("--nerdaxe-step-freq",
		     set_float_0_to_500, opt_show_intval, &opt_nerdaxe_step_freq,
		     "Ramp frequency step MHz 1-100"),
	OPT_WITH_ARG("--nerdaxe-step-delay",
		     set_int_0_to_9999, opt_show_intval, &opt_nerdaxe_step_delay,
		     "Ramp step interval range 1-600"),
	OPT_WITH_ARG("--nerdaxe-tune2",
			set_int_0_to_9999, opt_show_intval, &opt_nerdaxe_tune2,
...
static void hashmeter(int thr_id, uint64_t hashes_done)
{
	...
	if(thr_id >= 0) {		    
		double d64 = (double)total_rolling * 1000000ull;
		struct thr_info *thr = get_thread(thr_id);
		if(thr != NULL) {
		    struct cgpu_info *cgpu = thr->cgpu;
	    	if(cgpu != NULL) cgpu->hash_rate = d64;
		}
	}
