...
sudo git checkout build-2020-06-06
cd mxe
sudo git checkout build-2020-06-06
export MXE_DIR=/opt/mxe
export MXE_TARGETS='i686-w64-mingw32.static'
sudo make -j 2 -C $MXE_DIR MXE_TARGETS="$MXE_TARGETS" curl pthreads pdcurses ncurses libusb1 jansson libevent libmicrohttpd
